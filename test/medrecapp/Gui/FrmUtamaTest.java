...
public class FrmUtamaTest {
    ...
    public void b_insertDataDokter() {
        ...
        frame.textBox("txtAlamat").enterText("Jl. Mayor Dasuki Gg. Mangga No. 15 Jakarta");
        frame.button("btnInsert").click();
        ...
        frame.textBox("txtAlamat").enterText("Jl. Soekarno-Hatta Gg. Wayang No. 20 Bandung");
        frame.button("btnInsert").click();
        frame.optionPane().requireTitle("Insert Dokter");
        frame.optionPane().okButton().click();
    }
    ...
    public void d_insertDataStaf() {
        ...
        frame.textBox("txtAlamat").enterText("Jl. Cililitan Kecil No. 77 Jakarta Timur");
        frame.button("btnInsert").click();
        frame.optionPane().requireTitle("Insert Staf");
        frame.optionPane().okButton().click();

        frame.textBox("txtNamaStaf").enterText("Rudi Siahaan");
        frame.textBox("txtAlamat").enterText("Jl. Cililitan Besar No. 23 Jakarta Timur");
        frame.button("btnInsert").click();
        frame.optionPane().requireTitle("Insert Staf");
        frame.optionPane().okButton().click();
    }
    ...
    public void e_insertDataJaminan() {
        ...
        frame.textBox("txtKeterangan").enterText("Jaminan kesehatan khusus warga DKI Jakarta yang kurang mampu");
        frame.button("btnInsert").click();
